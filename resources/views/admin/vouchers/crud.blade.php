...
@stop
@section('content')
@section('title', (isset($edit) ? 'Edit ' : 'Add ') . 'Vouchers')
<style type="text/css">
.type_row {
    display: none;
}
...
<div class="page-content-inner">
  ...
  <form role="form" method="POST" action="{!! isset($edit) ? route('admin.vouchers.update', [$edit->id]) : route('admin.vouchers.store') !!}">    
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <div class="input-group col-md-12">
                                        <label>Number of vouchers to create</label>
                                ...
                                <div class="form-group">
                                    <div class="input-group col-md-12">
                                        ...
                                        <input type="text" class="form-control" name="premium_days" value="{!! old('premium_days') !!}"> 
                                    </div>
                                </div>
                            </div>
            ...
            <div class="portlet light ">
                ...
                <div class="portlet-body form">
                        <div class="form-actions">
                            ...
                            <button type="button" onclick="window.location.href='{!! route('admin.vouchers.index') !!}'" class="btn default">Cancel</button>
