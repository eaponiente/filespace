        ...
        <div class="col-md-12">
            ...
            <div class="portlet light portlet-fit portlet-datatable ">
                <div class="portlet-title">
                    <div class="caption">
                        <span class="caption-subject font-dark sbold uppercase">Abuses</span>
                    </div>
                    <div class="actions">
                ...
                <div class="portlet-body">
                    <div class="table-container">
                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_ajax" data-source="{!! route('abuses_listings') !!}" data-token="{!! csrf_token() !!}">
                            <thead>
                                <tr role="row" class="heading">
                                    <th>Code</th>
                                    <th width="14%">Email</th>
                                    <th width="12%">Reported Links</th>
                                    <th width="16%">Submit Date and Time</th>
                                    <th width="19%">Resolution Date and Time</th>
                                    <th width="13%"></th>
                                </tr>
                            </thead>
                            <tbody> 
